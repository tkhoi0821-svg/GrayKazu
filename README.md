...
Thư viện này cung cấp sẵn **513 icon hệ thống tiêu chuẩn** (Pin, Wifi, Bluetooth, Báo thức, Cài đặt,...) được đóng gói sẵn dưới dạng mảng dữ liệu đặt trong bộ nhớ Flash (`PROGMEM`), giúp tiết kiệm RAM tối đa cho vi điều khiển (ESP32, STM32, RP2040, Arduino...).
